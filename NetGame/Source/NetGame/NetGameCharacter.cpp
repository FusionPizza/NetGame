...
void ANetGameCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &ANetGameCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &ANetGameCharacter::LookUpAtRate);
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ANetGameCharacter::OnResetVR);
}


void ANetGameCharacter::OnResetVR()
{
